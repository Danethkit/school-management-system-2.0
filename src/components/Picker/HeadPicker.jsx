        ...
        <Grid container justify='center' style={{marginLeft:20, marginRight:20}}>
          {
            ...
            <Grid item xs={12} sm={6} md={4} lg={3} xl={3}><FacultyPicker user={userIden['user']}/></Grid>

            <Grid item xs={12} sm={6} md={4} lg={3} xl={3}><CoursePicker userIden={userIden} /></Grid>

            <Grid item xs={12} sm={6} md={4} lg={3} xl={3}><BatchPicker userIden ={userIden} /></Grid>

            <Grid item xs={12} sm={6} md={4} lg={3} xl={3} ><SessionPicker sessionNumber={sessionNumber} userIden={userIden}/></Grid>
